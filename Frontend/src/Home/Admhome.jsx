    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-blue-50 flex flex-col justify-center items-center px-6 md:px-16 py-10">
                ...
                <button onClick={() => navigator("/admindashboard")} className="bg-blue-200 text-white px-6 py-3 rounded hover:bg-blue-300">Dashboard</button>
            </div>
        </>
    );
};
