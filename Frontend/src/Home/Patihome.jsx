        ...
        <div className=" min-h-screen text-white">
            <section className=" flex flex-row items-center  px-12 py-10">
                ...
                <div className="w-1/2 pr-8">
                    <h1 className="text-4xl font-bold  mb-4 text-[#024c3b]">We Ensure The Well-Being of Your Health</h1>
                ...
                <div className="w-1/2 flex justify-center ">
                    <img
                        src="https://plus.unsplash.com/premium_photo-1661473820951-99a3565f3fca?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    ...
                    {specialties.map(({ icon, name, department, description }, i) => {
                        ...
                        return (
                            <div key={i} onClick={() => setActiveIndex(i)} className={`rounded-xl shadow-md overflow-hidden p-6 text-center cursor-pointer transition-colors duration-300 
                                    ${isActive
                                    ? "bg-[#a8eccc] text-[#1e6f5c]"
                                    : "bg-white text-gray-700 hover:bg-[#91e4c0] hover:text-[#1e6f5c]"}`}>
                                <div className="flex justify-center mb-2  text-3xl">{icon}</div>
                                <h3 className="text-xl mb-2 text-[#1e6f5c]">{name}</h3>
